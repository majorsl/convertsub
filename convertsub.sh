#!/usr/bin/env bash
# Version 1.0.1 *See README.md for requirements*
#
...
# Path to jq
JQ="/usr/bin/"
# Modify lines 32 and 42 for the subtitles you want to keep!
# -----------------------------------------------------------------------------------------------
IFS=$'\n'
...
# Function to process a single MKV file#!/usr/bin/env bash
# Version 1.0.2 *See README.md for requirements*
#
# SET YOUR OPTIONS HERE -------------------------------------------------------------------------
# Path to mkvmerge
MKVMERGE="/usr/bin/"
